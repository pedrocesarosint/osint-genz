...
- produção de relatórios, dossiês e pareceres.

## O que você encontra aqui

- Fundamentos de OSINT e SOCMINT.
...
- Separação entre fato, indício e hipótese.
- Validação cruzada antes de concluir.
...
Este repositório não ensina invasão de contas, engenharia social ofensiva, monitoramento abusivo ou qualquer prática ilegal. O foco é documentação metodológica e uso legítimo de fontes abertas.
